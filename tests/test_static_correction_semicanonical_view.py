...
and a J/K build on it raises. `max_memory = 0` forces that branch on water and
on the OH radical, and the view's V_Hxc must equal the in-core one to 1e-10 Ha.
